/*
	...
	07/05/17
	Dong(Bob) Lee
	Help received from: Luke Smith and Dr.Beaty	
...
/*
	The part below doesn't really make sense because one would expect that the outputs below will be printed out 
	at the end of the entire program, but that's not the case, at least in my implementation.
*/
