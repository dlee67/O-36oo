...
void scheduler (int signum)
{
	...
	while(countOfTerm != processes.size()){
		...
		/*
===========================================================================================================================
			Yes, it is, it's a problem with the kill(getpid(), STGSTOP);
			Everything makes sense, when the rootpid is locked, nothing really happens, and it is demonstrated in the 
			console.
...
//Okay, seems like I really should empty out the processes.
